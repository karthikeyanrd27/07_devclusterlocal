...
var_topic_src_name = 'NBC_APPS.TBL_MS_DIVISION_TEST'
var_topic_tgt_name = 'NBC_APPS.TBL_MS_DIVISION_TEST_COMPACT1'
...
#------------------------------------------------
# 00002 - Getting the offset Value from Zookeeper : 
#-------------------------------------------------
...
print("Offsetvalue management")
print(var_offset_path)
print(var_offset)
